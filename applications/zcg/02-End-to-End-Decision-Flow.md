...
Committee members review submitted proposals individually and collectively.

Observed elements include:
- Independent reading and assessment by committee members
- Informal clarification requests directed to applicants
- Reference to prior grants, ecosystem context, or stated ZCG priorities

Evaluation inputs may include:
- Applicant claims
- Prior work or reputation
...
Deliberation typically occurs:
- Internally among committee members
- With varying degrees of explicit reasoning recorded publicly

At this stage:
- Tradeoffs are weighed
- Uncertainty is resolved through discussion
...
Approved proposals may include explicit or implicit conditions.
...
- Reflected in grant agreements or public summaries
...
- Some grants provide periodic updates
- Others report only at milestones or completion
...
At the conclusion of a grant:
- Work may be considered complete
- A renewal may be proposed
- Or the grant relationship may end

Completion assessment may consider:
- Delivered outputs
- Alignment with original intent
- Ecosystem impact as perceived
...
Across all stages:
- Discretion and judgment are central
- Verification exists unevenly
